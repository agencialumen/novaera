                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center space-x-1 flex-wrap">
                            ...
                            {(post.authorUsername === "isabellelua" || post.authorUserType === "creator") && (
                              <div className="w-5 h-5 sm:w-5 sm:h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
                                <Verified className="h-3 w-3 sm:h-3 sm:w-3 text-primary-foreground" />
                              </div>
                            )}
